...
public:
 ...
 template<>
 std::vector< int > & get_data() { return int_data; }

 template<>
 std::vector< double > & get_data() { return dbl_data; }
 ...
 static void static_initialization() {
  register_method< DummyBlock >( "DummyBlock::set_data" ,
                                 &DummyBlock::set_data<int> ,
                                 MS_int_sbst::args() );
